...
equation
  ...
  connect(conEco.TMix, TMix) annotation (Line(points={{39,45},{-40,45},{-40,20},
          {-120,20}}, color={0,0,127}));
  connect(conEco.TRet, TRoo) annotation (Line(points={{39,42},{-34,42},{-34,12},
  ...
  connect(conMinOAFra.y, oveMinOAFra.u) annotation (Line(points={{-49,48},{-30,
          48},{-30,60},{2,60}}, color={0,0,127}));
  connect(oveMinOAFra.y, conEco.minOAFra) annotation (Line(points={{25,60},{34,
          60},{34,38},{39,38}}, color={0,0,127}));
